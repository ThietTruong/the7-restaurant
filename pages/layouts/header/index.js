      ...
      <div className={styles.header__bar}>
        ...
        <div className={styles.categories}>
          <ul className={styles.categories__list}>
            ...
            <li className={styles.categories__item}>
              <Link href="/">
                <a className={styles.item__category_link}>Menu</a>
              </Link>
            </li>
            <li className={styles.categories__item}>
              <Link href="/">
                <a className={styles.item__category_link}>Events</a>
              </Link>
            </li>
            <li className={styles.categories__item}>
              <Link href="/">
                <a className={styles.item__category_link}>News</a>
              </Link>
            </li>
            <li className={styles.categories__item}>
              <Link href="/">
                <a className={styles.item__category_link}>Contact</a>
              </Link>
            </li>
          </ul>
